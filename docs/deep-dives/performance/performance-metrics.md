...
## Overview
This topic matters in Android interviews because performance work requires frame timing and jank, startup latency, and memory and battery baselines rather than guesswork.
## Core Concepts
