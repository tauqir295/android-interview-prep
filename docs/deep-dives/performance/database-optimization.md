...
## Overview
This topic matters in Android interviews because performance work requires query/index tuning, batch write strategy, and cursor/window efficiency rather than guesswork.
## Core Concepts
