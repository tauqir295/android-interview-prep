...
## Layout Optimization Deep Dive
## Overview
This topic matters in Android interviews because performance work requires hierarchy flattening, inflation cost control, and recomposition/layout churn checks rather than guesswork.
## Core Concepts
