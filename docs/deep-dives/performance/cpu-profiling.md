...
## Overview
This topic matters in Android interviews because performance work requires hot method identification, lock contention analysis, and scheduler visibility rather than guesswork.
## Core Concepts
