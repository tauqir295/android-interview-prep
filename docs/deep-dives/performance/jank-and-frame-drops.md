...
## Jank And Frame Drops Deep Dive
## Overview
This topic matters in Android interviews because performance work requires frame budget discipline, main-thread scheduling, and render pipeline hotspots rather than guesswork.
## Core Concepts
