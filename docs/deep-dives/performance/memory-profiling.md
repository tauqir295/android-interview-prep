...
## Overview
This topic matters in Android interviews because performance work requires heap capture workflow, allocation tracking, and regression baselines rather than guesswork.
## Core Concepts
