...
## Initialization Patterns Deep Dive
## Overview
This topic matters in Android interviews because performance work requires startup dependency ordering, deferred init, and feature-gated warmup rather than guesswork.
## Core Concepts
