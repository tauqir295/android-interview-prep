...
## Bitmap Optimization Deep Dive
## Overview
This topic matters in Android interviews because performance work requires decode size control, bitmap reuse strategy, and image cache policy rather than guesswork.
## Core Concepts
