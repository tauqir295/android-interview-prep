...
## Overview
This topic matters in Android interviews because performance work requires allocation rate control, GC pause mitigation, and cache sizing rather than guesswork.
## Core Concepts
