...
## Overview
This topic matters in Android interviews because performance work requires measure/layout/draw phases, GPU handoff, and vsync alignment rather than guesswork.
## Core Concepts
