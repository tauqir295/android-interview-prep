...
## Overview
This topic matters in Android interviews because performance work requires bind-time minimization, diffing efficiency, and prefetch tuning rather than guesswork.
## Core Concepts
