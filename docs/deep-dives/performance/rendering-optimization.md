...
## Overview
This topic matters in Android interviews because performance work requires overdraw reduction, layer strategy, and invalidate scope control rather than guesswork.
## Core Concepts
