...
## Overview
This topic matters in Android interviews because performance work requires Perfetto traces, Android Studio profilers, and benchmark automation rather than guesswork.
## Core Concepts
