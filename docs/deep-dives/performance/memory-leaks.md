...
## Overview
This topic matters in Android interviews because performance work requires retained object chains, lifecycle ownership mistakes, and tool-assisted leak detection rather than guesswork.
## Core Concepts
