...
## Overview
This topic matters in Android interviews because performance work requires radio wakeups, background work batching, and sensor usage policy rather than guesswork.
## Core Concepts
