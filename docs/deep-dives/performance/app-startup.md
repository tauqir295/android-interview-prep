...
## App Startup Deep Dive
## Overview
This topic matters in Android interviews because performance work requires critical path trimming, lazy initialization, and first-frame prioritization rather than guesswork.
## Core Concepts
