...
## Migration And Evolution Strategies Deep Dive
## Overview
This topic is central to system design interviews because it forces explicit choices about strangler pattern, dual-write mitigation, and backward compatibility.
## Core Concepts
