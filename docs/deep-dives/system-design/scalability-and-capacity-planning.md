...
## Scalability And Capacity Planning Deep Dive
## Overview
This topic is central to system design interviews because it forces explicit choices about capacity modeling, autoscaling policies, and headroom and failover.
## Core Concepts
