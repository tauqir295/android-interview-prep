...
## Api Design And Gateways Deep Dive
## Overview
This topic is central to system design interviews because it forces explicit choices about API versioning, gateway policy enforcement, and rate limiting.
## Core Concepts
