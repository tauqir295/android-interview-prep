...
## Multi Region And Disaster Recovery Deep Dive
## Overview
This topic is central to system design interviews because it forces explicit choices about active-active vs active-passive, RPO/RTO targets, and traffic failover.
## Core Concepts
