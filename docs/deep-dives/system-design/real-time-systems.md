...
## Overview
This topic is central to system design interviews because it forces explicit choices about websocket fan-out, ordering guarantees, and presence and consistency.
## Core Concepts
